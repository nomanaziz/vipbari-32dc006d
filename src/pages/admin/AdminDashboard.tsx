  ...
  const statCards = [
    {
      ...
      trend: "+12%",
      up: true,
      bg: "from-pink-50 to-pink-100 dark:from-pink-950/40 dark:to-pink-900/30",
      iconBg: "bg-pink-500",
    ...
    },
    {
      ...
      trend: "+5%",
      up: true,
      bg: "from-fuchsia-50 to-fuchsia-100 dark:from-fuchsia-950/40 dark:to-fuchsia-900/30",
    ...
    },
    {
      ...
      trend: "",
      up: false,
      bg: "from-pink-50/50 to-purple-50 dark:from-pink-950/30 dark:to-purple-950/30",
      iconBg: "bg-pink-400",
